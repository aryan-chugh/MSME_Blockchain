...
async function main() {
  ...
  // 2. Deploy OracleStakingV3 (Latest version with multi-oracle consensus)
  console.log("2. Deploying Oracle Staking V3...");
  ...
  console.log("   Oracle Staking V3 deployed to:", oracleStakingAddress);
  console.log("   Governance:", governanceAddress, "\n");

  // 3. Deploy AttestationRegistryV3_1 (Latest version with self-assignment)
  console.log("3. Deploying Attestation Registry V3.1...");
  ...
  console.log("   Attestation Registry V3.1 deployed to:", attestationRegistryAddress, "\n");

  // 3b. Set attestation registry in OracleStakingV3
  console.log("3b. Configuring Oracle Staking V3...");
  await oracleStaking.setAttestationRegistry(attestationRegistryAddress);
  console.log("   Attestation registry address set in OracleStakingV3\n");
  ...
  LoanAgreementRegistry: '${loanAgreementRegistryAddress}',
  PlatformGovernance: '${platformGovernanceAddress}',
  MSMEIdentity: '${sampleMSMEIdentityAddress}'
};`;
    ...
    console.log("⚠️  Could not auto-update frontend addresses:", error.message);
    console.log("   Please run: node scripts/update-frontend-addresses.js");
  }
